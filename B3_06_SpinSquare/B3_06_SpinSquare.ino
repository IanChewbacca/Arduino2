...
void loop(void){
  ...
  delay(1000); // Delay for a second to give time to place the robot.
    ...
    spin(-101., TESTSPEED, motorLeft, motorRight); // 90 deg. to left
    allStop(FORWARD, motorLeft, motorRight);
    delay(500);  // Pause for 1/2 a second after turning
    drive(10., TESTSPEED, motorLeft, motorRight);// Forward for 10 inches
    spin(-105., TESTSPEED, motorLeft, motorRight); // 90 deg. to left
    allStop(FORWARD, motorLeft, motorRight);
    delay(500);  // Pause for 1/2 a second after turning
     drive(10., TESTSPEED, motorLeft, motorRight);// Forward for 10 inches
    spin(-102., TESTSPEED, motorLeft, motorRight); // 90 deg. to left
    allStop(FORWARD, motorLeft, motorRight);
    delay(500);  // Pause for 1/2 a second after turning
    drive(10., TESTSPEED, motorLeft, motorRight);// Forward for 10 inches
    spin(-105., TESTSPEED, motorLeft, motorRight); // 90 deg. to left
  ...
  delay(3000);
    ...
    drive(10., TESTSPEED, motorLeft, motorRight);// Forward for 10 inches
    spin(112., TESTSPEED, motorLeft, motorRight); // 90 deg. to left
    allStop(FORWARD, motorLeft, motorRight);
    delay(500);  // Pause for 1/2 a second after turning
     drive(10., TESTSPEED, motorLeft, motorRight);// Forward for 10 inches
    spin(113., TESTSPEED, motorLeft, motorRight); // 90 deg. to left
    allStop(FORWARD, motorLeft, motorRight);
    delay(500);  // Pause for 1/2 a second after turning
     drive(10., TESTSPEED, motorLeft, motorRight);// Forward for 10 inches
    spin(114., TESTSPEED, motorLeft, motorRight); // 90 deg. to left
    allStop(FORWARD, motorLeft, motorRight);
    delay(500);  // Pause for 1/2 a second after turning
     drive(10., TESTSPEED, motorLeft, motorRight);// Forward for 10 inches
    spin(114., TESTSPEED, motorLeft, motorRight); // 90 deg. to left
